...
namespace MyTTCBot.Data.Migrations
{
    ...
    partial class AddRoutesDirectionsStops
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("MyTTCBot.Models.TransitAgency", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("MyTTCBot.Models.AgencyRoute", b =>
                {
                    b.HasOne("MyTTCBot.Models.TransitAgency", "Agency")
                        .WithMany("Routes")
            ...
            modelBuilder.Entity("MyTTCBot.Models.UserChatContext", b =>
                {
                    b.HasOne("MyTTCBot.Models.TransitAgency", "TransitAgency")
                        .WithMany()
                        .HasForeignKey("AgencyId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
